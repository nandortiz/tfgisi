...
public class BibliotecaController extends Controller {
   ...
   public Result create(Http.Request request) throws SQLException, ClassNotFoundException {
    ...
    public Result retrieve (Http.Request request, int id) {
        logger.debug("In BibliotecaController.getBiblioteca(id), retrieve biblioteca with id: {}",id);
        Biblioteca result = BibliotecaBD.getInstance().getBiblioteca(id);
        ...
        if (request.accepts("text/html")) {
            ...
            logger.debug("In BibliotecaController.getBiblioteca(id), result is: {}",jsonObjects.toString());
            return ok(ApplicationUtil.createResponse(jsonObjects, true));
...
*/
public Result retrieveAll (Http.Request request) throws IOException, TemplateException {
    Collection<BibliotecaShort> result = BibliotecaBD.getInstance().getAllBibliotecas();
    logger.debug("In BibliotecaController.getAllBibliotecas(), result is: {}", result.toString());
